...
pmc.rowLayout(numberOfColumns=2,cw2=(80,10))
pmc.button(label='Make Locator', w=80, c=lambda *args:(spaceLocator(p = [mc.floatField('step_a',q=True,v=True), mc.floatField('step_b',q=True,v=True), mc.floatField('step_c',q=True,v=True)], a = True),CenterPivot()))
showWindow()
